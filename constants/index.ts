...
export const payment_methods = [
  {
    ...
    logo: require('@/assets/images/LNM.png'),
    description_string: "Lipa na M-PESA Ksh 199.00"
  },
  {
    name: "Google Pay",
    price: {
    ...
    logo: require('@/assets/images/google_pay.png'),
    description_string: "Complete payment with Google Pay"
  }
]
...
export const HEIGHTS_CM = [
  ...
  { label: "231 cm", value: 231 },
  { label: "241 cm", value: 241 },
];

export const HEIGHTS_INCHES = [
  { label: "4'0", value: "4'0" },
  { label: "4'1", value: "4'1" },
  { label: "4'2", value: "4'2" },
  { label: "4'3", value: "4'3" },
